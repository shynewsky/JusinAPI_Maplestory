...
#pragma region 히트박스크기 및 중점좌표 위치
	...
	m_tInfo = { 205.f, 535.f, m_fRectCX, m_fRectCY };

#pragma endregion

	__super::Update_Rect();

	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/NPC/NPC_dello_0,9.bmp", L"NPC_dello_0,9");
	m_tFrame = { 0, 8, 0, 300, GetTickCount() };
	m_pFrameKey = L"NPC_dello_0,9";
}

int CNPC_Dello::Update()
{
	return 0;
}

void CNPC_Dello::Late_Update()
{
	__super::Move_Frame();
}

void CNPC_Dello::Render(HDC hDC)
{
