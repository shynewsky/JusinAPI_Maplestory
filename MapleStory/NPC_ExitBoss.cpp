...
#pragma region 히트박스크기 및 중점좌표 위치
	...
	m_tInfo = { 70.f, 672.f, m_fRectCX, m_fRectCY };

#pragma endregion

	__super::Update_Rect();

	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/NPC/NPC_ExitBoss_0.bmp", L"NPC_ExitBoss_0");
	m_tFrame = { 0, 0, 0, 300, GetTickCount() };
	m_pFrameKey = L"NPC_ExitBoss_0";
}

int CNPC_ExitBoss::Update()
{
	return 0;
}

void CNPC_ExitBoss::Late_Update()
{
...
#pragma region 	NPC 주변에서 SPACE 누르면 대화창
	...
	{
		CUiMgr::Get_Instance()->Add_Object(UI_POPUP, CAbstractFactoryUI<CBossUI_ExitBox>::Create());
		return;
	}
...
void CNPC_ExitBoss::Render(HDC hDC)
{
