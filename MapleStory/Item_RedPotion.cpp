...
CItem_RedPotion::CItem_RedPotion()
{
}
...
void CItem_RedPotion::Initialize()
{
	m_eItemName = INAME_RedPotion;
	...
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_RedPotion_drop.bmp", L"Item_RedPotion_drop");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_RedPotion_slot.bmp", L"Item_RedPotion_slot");

	m_pFrameKey = L"Item_RedPotion_drop";
}

int CItem_RedPotion::Update()
{
	if (m_bDead)
...
void CItem_RedPotion::Late_Update()
{
	float	fY(0.f);
...
void CItem_RedPotion::Render(HDC hDC)
{
