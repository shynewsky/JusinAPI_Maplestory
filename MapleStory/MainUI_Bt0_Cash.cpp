...
CMainUI_Bt0_Cash::CMainUI_Bt0_Cash()
{
}
...
void CMainUI_Bt0_Cash::Initialize()
{
	m_tInfo = { 589.f, 567.5f, 32.f, 33.f };
...
void CMainUI_Bt0_Cash::Late_Update()
{
	POINT	ptMouse{};
...
void CMainUI_Bt0_Cash::Render(HDC hDC)
{
