...
CItem_BluePotion::CItem_BluePotion()
{
}
...
void CItem_BluePotion::Initialize()
{
	m_eItemName = INAME_BluePotion;
	...
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_BluePotion_drop.bmp", L"Item_BluePotion_drop");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_BluePotion_slot.bmp", L"Item_BluePotion_slot");

	m_pFrameKey = L"Item_BluePotion_drop";
}

int CItem_BluePotion::Update()
{
	if (m_bDead)
...
void CItem_BluePotion::Late_Update()
{
	float	fY(0.f);
...
void CItem_BluePotion::Render(HDC hDC)
{
