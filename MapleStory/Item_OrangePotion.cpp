...
CItem_OrangePotion::CItem_OrangePotion()
{
}
...
void CItem_OrangePotion::Initialize()
{
	m_eItemName = INAME_OrangePotion;
	...
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_OrangePotion_drop.bmp", L"Item_OrangePotion_drop");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_OrangePotion_slot.bmp", L"Item_OrangePotion_slot");

	m_pFrameKey = L"Item_OrangePotion_drop";
}

int CItem_OrangePotion::Update()
{
	if (m_bDead)
...
void CItem_OrangePotion::Late_Update()
{
	float	fY(0.f);
...
void CItem_OrangePotion::Render(HDC hDC)
{
...
void CItem_OrangePotion::Release()
{
}
