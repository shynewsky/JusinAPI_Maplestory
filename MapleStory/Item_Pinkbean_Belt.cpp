...
CItem_Pinkbean_Belt::CItem_Pinkbean_Belt()
{
}
...
void CItem_Pinkbean_Belt::Initialize()
{
	m_eItemName = INAME_PinkbeanBelt;
	...
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_belt_drop.bmp", L"Item_Pinkbean_belt_drop");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_belt_slot.bmp", L"Item_Pinkbean_belt_slot");

	m_pFrameKey = L"Item_Pinkbean_belt_drop";
}

int CItem_Pinkbean_Belt::Update()
{
	if (m_bDead)
...
void CItem_Pinkbean_Belt::Late_Update()
{
	float	fY(0.f);
...
void CItem_Pinkbean_Belt::Render(HDC hDC)
{
...
void CItem_Pinkbean_Belt::Release()
{
}
