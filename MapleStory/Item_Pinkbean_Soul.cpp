...
CItem_Pinkbean_Soul::CItem_Pinkbean_Soul()
{
}
...
void CItem_Pinkbean_Soul::Initialize()
{
	m_eItemName = INAME_PinkbeanSoul;
	...
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_soul_drop.bmp", L"Item_Pinkbean_soul_drop");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_soul_slot.bmp", L"Item_Pinkbean_soul_slot");

	m_pFrameKey = L"Item_Pinkbean_soul_drop";
}

int CItem_Pinkbean_Soul::Update()
{
	if (m_bDead)
...
void CItem_Pinkbean_Soul::Late_Update()
{
	float	fY(0.f);
...
void CItem_Pinkbean_Soul::Render(HDC hDC)
{
...
void CItem_Pinkbean_Soul::Release()
{
}
