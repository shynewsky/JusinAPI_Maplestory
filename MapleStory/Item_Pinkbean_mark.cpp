...
CItem_Pinkbean_mark::CItem_Pinkbean_mark()
{
}
...
void CItem_Pinkbean_mark::Initialize()
{
	m_eItemName = INAME_PinkbeanMark;
	...
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_mark_drop.bmp", L"Item_Pinkbean_mark_drop");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_mark_slot.bmp", L"Item_Pinkbean_mark_slot");

	m_pFrameKey = L"Item_Pinkbean_mark_drop";
}

int CItem_Pinkbean_mark::Update()
{
	if (m_bDead)
...
void CItem_Pinkbean_mark::Late_Update()
{
	float	fY(0.f);
...
void CItem_Pinkbean_mark::Render(HDC hDC)
{
...
void CItem_Pinkbean_mark::Release()
{
}
