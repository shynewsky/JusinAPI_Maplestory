...
CItem_Pinkbean_Hat::CItem_Pinkbean_Hat()
{
}
...
void CItem_Pinkbean_Hat::Initialize()
{
	m_eItemName = INAME_PinkbeanHat;
	...
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_hat_drop.bmp", L"Item_Pinkbean_hat_drop");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_hat_slot.bmp", L"Item_Pinkbean_hat_slot");

	m_pFrameKey = L"Item_Pinkbean_hat_drop";
}

int CItem_Pinkbean_Hat::Update()
{
	if (m_bDead)
...
void CItem_Pinkbean_Hat::Late_Update()
{
	float	fY(0.f);
...
void CItem_Pinkbean_Hat::Render(HDC hDC)
{
...
void CItem_Pinkbean_Hat::Release()
{
}
