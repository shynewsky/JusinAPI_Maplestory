...
CItem_Pinkbean_Suit::CItem_Pinkbean_Suit()
{
}
...
void CItem_Pinkbean_Suit::Initialize()
{
	m_eItemName = INAME_PinkbeanSuit;
	...
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_suit_drop.bmp", L"Item_Pinkbean_suit_drop");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_suit_slot.bmp", L"Item_Pinkbean_suit_slot");

	m_pFrameKey = L"Item_Pinkbean_suit_drop";
}

int CItem_Pinkbean_Suit::Update()
{
	if (m_bDead)
...
void CItem_Pinkbean_Suit::Late_Update()
{
	float	fY(0.f);
...
void CItem_Pinkbean_Suit::Render(HDC hDC)
{
...
void CItem_Pinkbean_Suit::Release()
{
}
