...
void CPinkFox::Initialize()
{
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Pet/Pet_PinkFox_left_0,7.bmp", L"Pet_PinkFox_left_0,7");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Pet/Pet_PinkFox_right_0,7.bmp", L"Pet_PinkFox_right_0,7");

	m_tInfo.fCX = 40.f;
	m_tInfo.fCY = 33.f;
	m_fSpeed = 50.f;

	m_pFrameKey = L"Pet_PinkFox_left_0,7";
...
void CPinkFox::Release()
{
}

void CPinkFox::Move_Around()
{
	...
	{
		m_pFrameKey = L"Pet_PinkFox_right_0,7";
