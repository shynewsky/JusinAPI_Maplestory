...
void CBlueFox::Initialize()
{
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Pet/Pet_BlueFox_left_0.7.bmp", L"Pet_BlueFox_left_0.7");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Pet/Pet_BlueFox_right_0.7.bmp", L"Pet_BlueFox_right_0.7");

	m_tInfo.fCX = 40.f;
	m_tInfo.fCY = 33.f;
	m_fSpeed = 150.f;

	m_pFrameKey = L"Pet_BlueFox_left_0.7";
...
void CBlueFox::Release()
{
}

void CBlueFox::Move_Around()
{
	...
	{
		m_pFrameKey = L"Pet_BlueFox_right_0.7";
