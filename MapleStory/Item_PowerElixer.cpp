...
CItem_PowerElixer::CItem_PowerElixer()
{
}
...
void CItem_PowerElixer::Initialize()
{
	m_eItemName = INAME_PowerElixer;
	...
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_PowerElixir_drop.bmp", L"Item_PowerElixir_drop");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_PowerElixir_slot.bmp", L"Item_PowerElixir_slot");

	m_pFrameKey = L"Item_PowerElixir_drop";
}

int CItem_PowerElixer::Update()
{
	if (m_bDead)
...
void CItem_PowerElixer::Late_Update()
{ 
	float	fY(0.f);
...
void CItem_PowerElixer::Render(HDC hDC)
{
...
void CItem_PowerElixer::Release()
{
}
