...
CItem_Pinkbean_Cup::CItem_Pinkbean_Cup()
{
}
...
void CItem_Pinkbean_Cup::Initialize()
{
	m_eItemName = INAME_PinkbeanCup;
	...
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_cup_drop.bmp", L"Item_Pinkbean_cup_drop");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_cup_slot.bmp", L"Item_Pinkbean_cup_slot");

	m_pFrameKey = L"Item_Pinkbean_cup_drop";
}

int CItem_Pinkbean_Cup::Update()
{
	if (m_bDead)
...
void CItem_Pinkbean_Cup::Late_Update()
{
	float	fY(0.f);
...
void CItem_Pinkbean_Cup::Render(HDC hDC)
{
...
void CItem_Pinkbean_Cup::Release()
{
}
