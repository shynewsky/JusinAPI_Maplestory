#include "pch.h"
#include "Boss_LeftBird.h"

#include "ScrollMgr.h"
#include "BmpMgr.h"

CBoss_LeftBird::CBoss_LeftBird()
	: m_fNpcWidth(440.f), m_fNpcHeight(590.f), m_fNpcFootX(591.f), m_fNpcFootY(585.f)
{
}
...
void CBoss_LeftBird::Initialize()
{
	...
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Boss/boss_LeftBird_stone_0.bmp", L"boss_LeftBird_stone_0");
	m_tFrame = { 0, 0, 0, 300, GetTickCount() };
	m_pFrameKey = L"boss_LeftBird_stone_0";
}

int CBoss_LeftBird::Update()
{
	return 0;
}

void CBoss_LeftBird::Late_Update()
{
	__super::Move_Frame();
}

void CBoss_LeftBird::Render(HDC hDC)
{
