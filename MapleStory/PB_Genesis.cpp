...
#pragma endregion
	...
	m_tFrame = { 0, 15, 0, 200, GetTickCount() };
	m_pFrameKey = L"boss_pinkbean_genesis_effect_0,15";

	__super::Update_Rect();

}

int CPB_Genesis::Update()
{
	if (m_bDead)
		return OBJ_DEAD;
...
void CPB_Genesis::Render(HDC hDC)
{
