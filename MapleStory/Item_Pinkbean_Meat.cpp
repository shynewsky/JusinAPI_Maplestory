...
CItem_Pinkbean_Meat::CItem_Pinkbean_Meat()
{
}
...
void CItem_Pinkbean_Meat::Initialize()
{
	m_eItemName = INAME_PinkbeanMeat;
	...
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_meat_drop.bmp", L"Item_Pinkbean_meat_drop");
	CBmpMgr::Get_Instance()->Add_Bmp(L"../Data/Item/Item_Pinkbean_meat_slot.bmp", L"Item_Pinkbean_meat_slot");

	m_pFrameKey = L"Item_Pinkbean_meat_drop";
}

int CItem_Pinkbean_Meat::Update()
{
	if (m_bDead)
...
void CItem_Pinkbean_Meat::Late_Update()
{
	float	fY(0.f);
...
void CItem_Pinkbean_Meat::Render(HDC hDC)
{
...
void CItem_Pinkbean_Meat::Release()
{
}
